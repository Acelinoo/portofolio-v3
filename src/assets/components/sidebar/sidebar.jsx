      ...
      <ul className="flex flex-col items-center space-y-4">
        <li>
          <a href="https://github.com/Acelinoo" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/github.png" alt="Github" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
        <li>
          <a href="https://www.instagram.com/acelino/" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/instagram (1).png" alt="Instagram" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
        <li>
          <a href="https://www.tiktok.com/@acelino.k" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/tiktok.png" alt="TikTok" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
        <li>
          <a href="/" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/linkedin.png" alt="LinkedIn" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
        <li>
          <a href="/" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/twitter.png" alt="Twitter" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
        <li>
          <a href="https://open.spotify.com/playlist/29cax5tGOyot4CIkeeeUNO?si=CQggO0GjQLyHoMtiisuQOA" target="_blank" rel="noopener noreferrer">
            <img src="/src/assets/images/spotify.png" alt="Spotify" className="w-7 object-contain hover:scale-125 transition-transform" />
          </a>
        </li>
      </ul>
    </div>
