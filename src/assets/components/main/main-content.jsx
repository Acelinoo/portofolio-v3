...
const MainContent = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-center min-h-screen px-6 md:px-8 text-center md:text-left">
      
      {/* Konten Teks */}
      <div className="mt-6 md:mt-0 md:mr-12">
      ...
      {/* Gambar Profil */}
      <div className="relative w-44 h-60 md:w-56 md:h-72 group cursor-pointer mb-6 md:mb-0">
        <img
