...
void main() {
    ...
    if (VAR == 0) {
        ...
        if (u_resolution.x > u_resolution.y) {
            ...
            aspect.y = u_resolution.y / u_resolution.x;
        }
        // Multiply by 2.1 and add roundness so that size=1.0 touches the canvas edges
        vec2 boxSize = vec2(size * 2.1) * aspect + vec2(roundness);
        sdf = sdRoundRect(st, boxSize, roundness);
